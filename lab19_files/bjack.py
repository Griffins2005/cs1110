...
Version: Apr 28, 2025
"""
import onioncard as card  # STUDENTS: note this import statement
import random

# STUDENTS: look like the words "copy the methods" below.
...
class Blackjack:
    ...
    # STUDENTS: copy the methods *you* wrote in the previous lab
    # on classes here. (You didn't write the `play` method, so leave
    # it alone.)
